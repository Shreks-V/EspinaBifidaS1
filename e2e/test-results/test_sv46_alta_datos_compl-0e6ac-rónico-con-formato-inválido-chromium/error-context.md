...
- Name: test_sv46_alta_datos_complejos_beneficiarios.spec.ts >> SV-46 / alta datos complejos beneficiarios (UI) >> negativo: correo electrónico con formato inválido
- Location: tests\test_sv46_alta_datos_complejos_beneficiarios.spec.ts:100:7
